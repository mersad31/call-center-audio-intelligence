...
# ==============================================================================
# پیدا کردن مسیر روت پروژه (یک پوشه بالاتر از پوشه app)
BASE_DIR = Path(__file__).resolve().parent.parent

# ساخت مسیر پوشه و فایل دیتابیس دقیقاً در root/log
DB_DIR = BASE_DIR / "log"
...
async def async_log_to_db(*args, **kwargs):
    """Asynchronously wrap the DB insert to be truly non-blocking using threads."""
...
def purge_logs(days: int) -> int:
    ...
    try:
        ...
        # استفاده از isolation_level=None برای اجرای ایمن و بدون تراکنشِ دستور VACUUM
        ...
        return -1  # برگشت دادن ۱- جهت مچ شدن با هندلر ارور ۵۰۰ اندپوینت شما