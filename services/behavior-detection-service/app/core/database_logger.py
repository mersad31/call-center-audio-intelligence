...
# ==============================================================================
# پیدا کردن مسیر روت پروژه (با توجه به اینکه این فایل در app/core قرار دارد)
...
print(f"\n[INFO] Database is being stored exactly at: {DB_PATH}\n")
...
# مقداردهی اولیه دیتابیس در زمان لود شدن این ماژول
init_db()